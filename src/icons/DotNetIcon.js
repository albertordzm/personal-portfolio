...
const DotNetIcon = (props) => {
  return (
    <svg aria-labelledby="simpleicons-dot-net-icon" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" styleName="icon--skill">
      <title id="simpleicons-dot-net-icon">.NET icon</title>
...
export default CSSModules(DotNetIcon, styles);
